...
if ("/BURADiO-Team/home" == $linkchk) {
 $activehm = "active_menu_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/notification" == $linkchk) {
 $activent = "active_menu_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/mailbox" == $linkchk) {
 $activeml = "active_menu_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/profile" == $linkchk) {
 $activepf = "sub_active_tab_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/posts" == $linkchk) {
 $activept = "sub_active_tab_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/score" == $linkchk) {
 $activesr = "sub_active_tab_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/activitylog" == $linkchk) {
 $activeal = "sub_active_tab_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/attendence" == $linkchk) {
 $activeat = "sub_active_tab_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/notice" == $linkchk) {
 $activenc = "sub_active_tab_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/schedule" == $linkchk) {
 $activese = "sub_active_tab_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/members" == $linkchk) {
 $activemm = "sub_active_tab_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/settings" == $linkchk) {
 $activest = "sub_active_tab_snn";
 $cklnk    = "ok";
} elseif ("/BURADiO-Team/ajax/wrong-url" == $linkchk) {
 echo "<script type='text/javascript'> document.location = '../home.php'; </script>";
 exit;
} elseif ("/BURADiO-Team/db/wrong-url" == $linkchk) {
 echo "<script type='text/javascript'> document.location = '../home.php'; </script>";
 exit;
} elseif ("/BURADiO-Team/pages/wrong-url" == $linkchk) {
 echo "<script type='text/javascript'> document.location = '../home.php'; </script>";
 exit;
} else {
...
if ("/BURADiO-Team/home" == $link) {
 include_once 'pages/feed.php';
} elseif ("/BURADiO-Team/notification" == $link) {
 include_once 'pages/notification.php';
} elseif ("/BURADiO-Team/mailbox" == $link) {
 include_once 'pages/mailbox.php';
} elseif ("/BURADiO-Team/profile" == $link) {
 include_once 'pages/profile.php';
} elseif ("/BURADiO-Team/posts" == $link) {
 include_once 'pages/posts.php';
} elseif ("/BURADiO-Team/score" == $link) {
 include_once 'pages/score.php';
} elseif ("/BURADiO-Team/activitylog" == $link) {
 include_once 'pages/activity.php';
} elseif ("/BURADiO-Team/attendence" == $link) {
 include_once 'pages/attend.php';
} elseif ("/BURADiO-Team/notice" == $link) {
 include_once 'pages/notice.php';
} elseif ("/BURADiO-Team/schedule" == $link) {
 include_once 'pages/schedule.php';
} elseif ("/BURADiO-Team/members" == $link) {
 include_once 'pages/members.php';
} elseif ("/BURADiO-Team/settings" == $link) {
            ...
            <div class="profile_menus">
                ...
                <div class="profileModal">
                    ...
                    <div class="prfil-btns">
                        <button class="pro_button" style="max-width: 130px;"><a style="text-decoration: none; color: #ffffff;" class="profile" onClick="chargue('.left', 'pages/profile')">View Profile</a></button>
