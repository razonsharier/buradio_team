...
if ($linkchk == "/buradio_team/home") {
    ...
    $cklnk = "ok";
} elseif ($linkchk == "/buradio_team/help") {
    $activehp = "sub_active_tab_snn";
    $cklnk = "ok";
} elseif ($linkchk == "/buradio_team/report") {
    $activerp = "sub_active_tab_snn";
    $cklnk = "ok";
...
<body>
    ...
    <div class="header">
        <div class="page_container">
            <div class="header_content">
                ...
                <div class="site_logo">
                    <a href="index.php"><img src="image/logo.png" style="height: 50px; width: 50px" /></a>
                </div>
                ...
                <div class="top_menu">
                    <ul>
                        <li class="<?php echo $activehm; ?>">
                            <!-- class="active_menu" -->
                            <a id="feed" onClick="chargue('.left', 'pages/feed.php')">
                        ...
                        <li class="<?php echo $activent; ?>">
                            <a id="noti" onClick="chargue('.left', 'pages/notification.php')">
                                <div class="active_hover">
                        ...
                        <li class="<?php echo $activeml; ?>">
                            <a id="mail" onClick="chargue('.left', 'pages/mailbox.php')">
                                <div class="active_hover">
    ...
    <div class="page_cntnt_container">
        <div class="sndlftclm">
            <div class="leftColumn">
                ...
                <ul>
                    <li class="<?php echo $activepf; ?>"><a class="profile" onClick="chargue('.left', 'pages/profile.php')">Profile</a></li>
                    <li class="<?php echo $activept; ?>"><a class="posts" onClick="chargue('.left', 'pages/posts.php')">Posts</a></li>
                    <li class="<?php echo $activesr; ?>"><a class="score" onClick="chargue('.left', 'pages/score.php')">Score</a></li>
                    <li class="<?php echo $activeal; ?>"><a class="activity" onClick="chargue('.left', 'pages/activity.php')">Activity Log</a></li>
                    <li class="<?php echo $activeat; ?>"><a class="attend" onClick="chargue('.left', 'pages/attend.php')">Attendence</a></li>
                    <li class="<?php echo $activenc; ?>"><a class="notice" onClick="chargue('.left', 'pages/notice.php')">Notice</a></li>
                    <li class="<?php echo $activese; ?>"><a class="schedule" onClick="chargue('.left', 'pages/schedule.php')">Schedule</a></li>
                    <li class="<?php echo $activemm; ?>"><a class="members" onClick="chargue('.left', 'pages/members.php')">Members</a></li>
                    <li class="<?php echo $activehp; ?>"><a class="help" onClick="chargue('.left', 'pages/help.php')">Help</a></li>
                    <li class="<?php echo $activerp; ?>"><a class="report" onClick="chargue('.left', 'pages/report.php')">Report</a></li>
                    <li class="<?php echo $activest; ?>"><a class="settings" onClick="chargue('.left', 'pages/settings.php')">Settings</a></li>
                    <div style="border-top: 1px solid #ccc; margin-bottom: 10px;"></div>
                    <li><a href="#">rj hunt 2020 admin page</a></li>
        ...
        <div class="left">
            ...
            } elseif ($link == "/buradio_team/help") {
                include_once('pages/help.php');
            } elseif ($link == "/buradio_team/report") {
            ...
            <div class="profile_menus">
                ...
                <div class="profileModal">
                    ...
                    <div class="prfil-btns">
                        <button style="max-width: 130px;">View Profile</button>
    ...
    <script>
        ...
        $(function() {
            $('.help').click(function() {
                changeUrl('Help Page', 'help');
            });
        });

        $(function() {
            $('.report').click(function() {
                changeUrl('Report Page', 'report');
            });
        });
